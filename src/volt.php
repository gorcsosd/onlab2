        ...
        <nav>
            ...
            <ul>
              <li><a href="amper.php">Amper (A)</a></li>
                ...
                <li class="active"><a href="volt.php">Volt (V)</a></li>
...
<p>A volt az elektromos feszültség vagy más néven potenciálkülönbség mértékegysége az SI rendszerben.</p>
<p>&nbsp;</p>
<p>Jele: V</p>
<p>&nbsp;</p>
<p>Nevét Alessandro Volta (1745–1827) olasz fizikusról kapta.</p>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <td>" . $row["nev"]. "volt</td>
        <td>" . $row["jel"]. "V </td> 
        <td> 1 " . $row["jel"]. "V = " . $row["atvaltas"]. " V </td>
        </tr>";
    }
    echo "</table>";
} 
