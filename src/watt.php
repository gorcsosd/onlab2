        ...
        <nav>
            ...
            <ul>
              <li><a href="amper.php">Amper (A)</a></li>
                ...
                <li class="active"><a href="watt.php">Watt (W)</a></li>
            </ul>
...
<p>A watt a teljesítmény SI-ből származtatott mértékegysége.</p>
<p>&nbsp;</p>
<p>Jele: W</p>
<p>&nbsp;</p>
<p>Az elnevezés James Watt skót feltaláló és mérnök nevéből származik.</p>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <td>" . $row["nev"]. "watt</td>
        <td>" . $row["jel"]. "W </td> 
        <td> 1 " . $row["jel"]. "W = " . $row["atvaltas"]. " W </td>
        </tr>";
    }
    echo "</table>";
} 
